...
namespace TestingProjectWebsite.Features
{
    ...
    public partial class CreateAnUserFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "CreateAnUser", "\tIn order access an accout\r\n\tI have to create an user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void CreateAnUser(string userEmailValue, string userFirstNameValue, string userLastNameValue, string userPhoneValue, string userAddressValue, string userPasswordValue, string userAddressFirstNameValue, string userAddressLastNameValue, string userCityValue, string userPostalCodeValue, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CreateAnUser", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line 8
 testRunner.Then("I fill desired email", ((string)(null)), table3, "Then ");
#line hidden
...
#line 11
 testRunner.When("I fill the register form with following data", ((string)(null)), table4, "When ");
#line hidden
#line 14
